...
local raise_volume = "wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%+ && swayosd-client --output-volume raise"
local lower_volume = "wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%- && swayosd-client --output-volume lower"
local mute_toggle = "wpctl set-mute @DEFAULT_AUDIO_SINK@ toggle && swayosd-client --output-volume toggle-mute"
